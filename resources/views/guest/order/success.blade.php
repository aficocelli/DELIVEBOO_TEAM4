...
<div id="root" class="container-sm info_success">
  <h1 class="mt-3 text-capitalize mb-3">Il tuo ordine è confermato <span class="text-success wink_custom"><i class="fas fa-check-circle"></i></span></h1>
  ...
  <div class="container-sm mt-3 mb-5">     
    ...
    <h4 class="text-capitalize mb-3"><strong>Totale ordine:</strong> {{$order->total = number_format($order->total, 2)}} € </h4>
